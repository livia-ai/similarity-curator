...
var SCHEMA = {
  name: 'livia',
  vectors: {
    size: _Config["default"].DIMENSION,
    distance: 'Cosine'
  }
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _nodeFetch["default"])(BASE + '/collections/livia').then(function (res) {
              return res.json();
            });
          ...
          case 8:
            ...
            _context.next = 11;
            return (0, _nodeFetch["default"])(BASE + '/collections/livia', {
              method: 'PUT',
              headers: headers,
          ...
          case 11:
            _context.next = 13;
            return (0, _nodeFetch["default"])(BASE + '/collections/livia/index', {
              method: 'POST',
              headers: headers,
              body: JSON.stringify({
                field_name: 'id',
          ...
          case 15:
            return _context.abrupt("return", ingest().then(function () {
...
var ingest = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var ingestOneBatch, ingestOneDataset;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            ingestOneBatch = function ingestOneBatch(batch) {
              console.log('[Qdrant] Ingesting batch of ' + batch.length);
              return (0, _nodeFetch["default"])(BASE + '/collections/livia/points', {
                method: 'PUT',
                headers: headers,
                body: JSON.stringify({
                  points: batch
            ...
            ingestOneDataset = function ingestOneDataset(museum, path) {
              return new Promise(function (resolve) {
                ...
                lr.on('line', function (line) {
                  ...
                  if (!json.vec) console.log('No vector', line);
                  batch.push({
                    id: (0, _uuid.v4)(),
                    payload: {
                      id: String(json.id),
            ...
            return _context2.abrupt("return", _Config["default"].DATA.reduce(function (res, d) {
